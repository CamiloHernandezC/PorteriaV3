...
public class AreasEmpresaController implements Serializable {
    ...
    public AreasEmpresa getSelected() {
        return selected;
    }

    public void setSelected(AreasEmpresa selected) {
    ...
    private AreasEmpresaFacade getFacade() {
        return ejbFacade;
    }

    public AreasEmpresa prepareCreate() {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("AreasEmpresaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("AreasEmpresaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("AreasEmpresaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<AreasEmpresa> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<AreasEmpresa> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
