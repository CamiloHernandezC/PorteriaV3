...
public class MovHerramientasCliController implements Serializable {
    ...
    public MovHerramientasCli prepareCreate() {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("Utils/Bundle").getString("MovHerramientasCliCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("Utils/Bundle").getString("MovHerramientasCliUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("Utils/Bundle").getString("MovHerramientasCliDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<MovHerramientasCli> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<MovHerramientasCli> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
