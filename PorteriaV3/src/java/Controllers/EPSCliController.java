...
public class EPSCliController implements Serializable {
    ...
    private EPSCli selected;

    public EPSCliController() {
    }

    public EPSCli getSelected() {
        return selected;
    }

    public void setSelected(EPSCli selected) {
    ...
    private EPSCliFacade getFacade() {
        return ejbFacade;
    }

    public EPSCli prepareCreate() {
        selected = new EPSCli();
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("Utils/Bundle").getString("EPSCliCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("Utils/Bundle").getString("EPSCliUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("Utils/Bundle").getString("EPSCliDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public EPSCli getEPSCli(java.lang.String id) {
        return getFacade().find(id);
    }

    public List<EPSCli> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<EPSCli> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class EPSCliControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getEPSCli(getKey(value));
        }
