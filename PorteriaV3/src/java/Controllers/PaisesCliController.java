...
public class PaisesCliController implements Serializable {
    ...
    public PaisesCli prepareCreate() {
        selected = new PaisesCli();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("Utils/Bundle").getString("PaisesCliCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("Utils/Bundle").getString("PaisesCliUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("Utils/Bundle").getString("PaisesCliDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<PaisesCli> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<PaisesCli> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
